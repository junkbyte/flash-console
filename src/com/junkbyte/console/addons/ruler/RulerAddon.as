...
package com.junkbyte.console.addons.ruler
{
	...
	public class RulerAddon extends Sprite
	{
		...
		public static function addToMenu(menuName:String = "RL", console:Console = null):void
		{
			...
			if (console)
			{
				console.addMenu(menuName, startRuler, new Array(console), "Screen Ruler::Measure the distance and angle between two points on screen.");
			}
		}
		...
		{
			var format:TextFormat = new TextFormat(config.style.menuFont, config.style.menuFontSize, col, b, true, null, null, TextFormatAlign.RIGHT);
